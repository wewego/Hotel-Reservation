...
<body>
	...
	<?php
	   if ($_POST['country'] == 'Egypt')
	   {
		...
		<form id = "contact-form" method="post" action="displayPrice.php">
	   	<select class="contact-form" required name = "hotel">
		   		...
		   		<br>
		   		<input name="next" type="submit" class="price_reservation" value="Back" formaction = "prices.php" formnovalidate>
